...
Expõe:
  GET  /health    — Liveness probe (AC-1, AC-11)
  POST /otimizar  — Solve do corte unidimensional (AC-2..AC-12)

Proteção de traceback em produção: AC-12.
"""
...
# ---------------------------------------------------------------------------
# Instância do FastAPI com metadados para Swagger (AC-11)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Handler global de erros — garante que tracebacks não vazem (AC-12)
# ---------------------------------------------------------------------------
...
async def generic_exception_handler(request: Request, exc: Exception) -> JSONResponse:
    ...
    # Em produção: mensagem genérica sem traceback (AC-12)
    return JSONResponse(
        status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def otimizar(
    ...
    Cobre: AC-2, AC-6, AC-7, AC-8, AC-9.
    """
